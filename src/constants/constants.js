...
export const DROPDOWN_SINGLE_FILTERS = { type: 'checkbox', items: ['Полная занятость', 'Частичная занятость', 'Стажировка', 'Проектная работа'] }
...
export const FITLER_SETTINGS = [
	{ iconName: 'location', text: 'Город', type: PropTypes.input, additionalFilters: null },
